            ...
            <div class="row">
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="time" value="{{ old('class_start') }}" name="class_start" class="form-control{{ $errors->has('class_start') ? ' is-invalid' : '' }}" id="class_start" />                            
                    @if ($errors->has('class_start'))
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $errors->first('class_start') }}</strong>
                        </span>
                        @endif
                    </div>
                </div>
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="time" value="{{ old('class_end') }}" name="class_end" id="class_end" class="form-control{{ $errors->has('class_end') ? ' is-invalid' : '' }}" />
