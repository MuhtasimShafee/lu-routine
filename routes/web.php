...
Route::middleware(['admin'])->group(function () {
    ...
    //Section
    Route::get('/dashboard/section', 'settings\SectionController@index')->name('section.index');
    Route::get('/dashboard/section/create', 'settings\SectionController@create')->name('section.create');
    Route::post('/dashboard/section/create', 'settings\SectionController@store')->name('section.store');
    Route::get('/dashboard/section/{id}/edit', 'settings\SectionController@edit')->name('section.edit');
    Route::post('/dashboard/section/{id}/update', 'settings\SectionController@update')->name('section.update');
    Route::get('/dashboard/section/{id}/delete', 'settings\SectionController@destroy')->name('section.delete');
    //batch
    Route::get('/dashboard/batch', 'settings\BatchController@index')->name('batch.index');
    Route::get('/dashboard/batch/create', 'settings\BatchController@create')->name('batch.create');
    Route::post('/dashboard/batch/create', 'settings\BatchController@store')->name('batch.store');
    Route::get('/dashboard/batch/{id}/edit', 'settings\BatchController@edit')->name('batch.edit');
    Route::post('/dashboard/batch/{id}/update', 'settings\BatchController@update')->name('batch.update');
    Route::get('/dashboard/batch/{id}/delete', 'settings\BatchController@destroy')->name('batch.delete');
    ...
    Route::get('/dashboard/sunday/sunday-edit', 'routine\days\SundayController@editIndex')->name('sunday.editIndex');
