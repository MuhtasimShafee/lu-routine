                                    ...
                                    <ul class="menu-subnav">
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{route('batch.index')}}" class="menu-link">
                                                ...
                                                <span class="menu-text">See Batches</span>
                                            </a>
                                        </li>
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{route('batch.create')}}" class="menu-link">
                                                ...
                                                <span class="menu-text">Add Batch</span>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                                    ...
                                    <ul class="menu-subnav">
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="{{route('section.index')}}" class="menu-link">
                                                ...
                                                <span class="menu-text">See Sections</span>
                                            </a>
                                        </li>
                                        <li class="menu-item" aria-haspopup="true">
                                        ...
                                        <li class="menu-item menu-item-submenu" aria-haspopup="true"
                                            ...
                                            <div class="menu-submenu">
                                                ...
                                                <ul class="menu-subnav">
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{route('sunday.editIndex')}}" class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
                                                                <span></span>
                                                            </i>
                                                            <span class="menu-text">Edit Sunday Data</span>
                                                        </a>
                                                    </li>
                                                </ul>
                                            </div>
