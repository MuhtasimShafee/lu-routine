            ...
            <div class="row">
                <div class="col">
                    <div class="form-group">
                        ...
                        <select name="room_id" class="form-select form-select-md room_id" id="room_id" >
                            ...
                            <option {{ $sunday->id == $room->id ? 'SELECTED' : '' }} value="{{ $room->id }}">{{ $room->room_title }} ({{ $room->room_code }})</option>
                            @endforeach
                        </select>
                    </div>
                </div>  
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="time" value="{{$sunday->class_start}}" name="class_start" class="form-control form-control-sm class_start" id="class_start" />                            
                    </div>
                </div>
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="time" value="{{$sunday->class_end}}" name="class_end" class="form-control form-control-sm class_end" id="class_end" />
                    </div>
                </div>
